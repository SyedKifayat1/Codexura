            ...
            <div className="testimonials-cards">
                <div className="testimonials-card" data-aos="fade-right" data-aos-delay='200'>
                    ...
                    <div className='testimonials-card-content' >
                        <p className="testimonial-text">Codexura created a website that exceeded our expectations. We're seeing great results and highly recommend their services!</p>
                ...
                <div className="testimonials-card" data-aos="fade-up" data-aos-delay='200'>
                    ...
                    <div className='testimonials-card-content'>
                        <p className="testimonial-text">Great experience working with Codexura. They delivered a website that's beautiful, user-friendly, and drives traffic.</p>
                        <div className="small-line"></div>
                ...
                <div className="testimonials-card" data-aos="fade-up" data-aos-delay='200'>
                    ...
                    <div className='testimonials-card-content'>
                        <p className="testimonial-text">Codexura helped us create engaging content that's boosted our website traffic and brand awareness. We're very happy with their work!</p>
                        <div className="small-line"></div>
